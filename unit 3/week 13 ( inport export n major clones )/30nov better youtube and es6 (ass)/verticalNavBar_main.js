 let status = "on";
    document.getElementById("hamburger").addEventListener("click" , () => {
        ...
        if(status == "on"){
            // alert("navbar is closing now");
            status = "off";
            const vNav = document.getElementById("verticalNav");
            vNav.style.width = "70px"
            vNav.innerHTML = null;
            vNav.innerHTML= `
            <ul class="verticalNav_off">
                <li class="active">
                    <div class="icon">
            ...
            // alert("navbar is opening now");
            status = "on";
            const vNav = document.getElementById("verticalNav");
            vNav.style.width = "260px"
            vNav.innerHTML = null;
            vNav.innerHTML = `
            <ul class="verticalNav_on skickey_sidenava">
                <li class="active">
                    <div class="icon">
                        <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" class="style-scope yt-icon"
                            style="pointer-events: none; display: block; width: 100%; height: 100%;">
